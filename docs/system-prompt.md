...
- Rate limiting: DB-based via ai_insights count queries (serverless-safe). Basic: 5 trade analyses/month + 1 monthly review (30-day data). Elite: 100 analyses/month + 4 reviews/month.
