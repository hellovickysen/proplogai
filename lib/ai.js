...
Respond with ONLY valid JSON, NO markdown fences, matching this shape:
{
  ...
  "one_habit": { "habit": "<2-5 word label>", "reason": "<one sentence explaining WHY, referencing trader's own data>", "estimated_pnl_impact": <dollar improvement>, "confidence_pct": <0-100>, "trade_count": <number of trades> },
