...
- Never estimate dollar amounts → describe qualitative improvement ("higher consistency", "better execution")
...
Respond with ONLY valid JSON, NO markdown fences:
{
  ...
  "one_habit": { "habit": "<2-5 word label>", "reason": "<one sentence from trader's own data>", "improvement": "<qualitative: e.g. 'Higher consistency' or 'Better execution quality'>", "evidence_strength": <0-100>, "trade_count": <number> },
  "best_habit": { "habit": "<what the trader does WELL>", "win_rate": <percentage>, "trade_count": <number>, "message": "<short encouragement: 'Keep doing this'>" },
