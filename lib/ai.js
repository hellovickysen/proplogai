...
Respond with ONLY valid JSON, NO markdown fences, matching this shape:
{
  ...
  "recurring_mistakes": [{"pattern": "<2-4 word label>", "severity": "high", "frequency": "<count>", "impact": "<max 10 words>", "fix": "<max 10 words>"}],
  "psychology": {"summary": "<1-2 sentences>", "insights": [{"emotion": "<tag>", "percentage": <number>, "stat": "<short>", "observation": "<max 10 words>"}], "guardrails": ["<max 10 words each>"]},
  ...
  "action_plan": ["<max 10 words each>"]
}

Keep arrays to max 3-4 items. Be concise.`;
