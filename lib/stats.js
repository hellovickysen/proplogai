...
export function computeStats(trades) {
  ...
  return { n, net, winRate, profitFactor, wins: wins.length, losses: losses.length };
}
...
/**
 * Get the current trading date as YYYY-MM-DD string.
 * Trading day boundary = midnight UTC = 5:30 AM IST.
 * A trade at 3:00 AM IST belongs to the previous trading day.
 * A trade at 6:00 AM IST belongs to the new trading day.
 */
...
/**
 * Get the current trading month as YYYY-MM string.
 * Uses the same UTC boundary as getTradingDate.
 */
export function getTradingMonth() {
