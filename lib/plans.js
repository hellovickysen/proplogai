 ...
 *
 * Two plans: Basic (₹0) and Elite (₹799/mo or ₹599/mo yearly).
 * Launch pricing: ₹499/mo for first 100 users (locked for life).
...
export const PLANS = {
  ...
  elite: {
    ...
    price: '₹799/mo',
    priceMonthly: 799,
    priceYearly: 599, // per month billed annually (₹7,188/yr)
    badge: 'Elite',
...
export const ELITE_FEATURES = [
  ...
  { icon: '📤', label: 'CSV export & shareable P&L cards' },
