...
// Influencer codes give the buyer 30% off. The actual charge is enforced by
// the Razorpay Offer — this constant must match the offer's discount.
...
/**
 * Razorpay Offer id for the partner discount, per payment method.
 * RAZORPAY_OFFER_ID_5 = Card offer (kept for backward compatibility);
 * RAZORPAY_OFFER_ID_5_UPI = UPI offer. Defaults to 'card'.
 */
...
/** Which payment methods the partner discount is configured for. */
