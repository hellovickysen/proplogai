...
const TOOLS = [
  {
    title: 'Trader Survival Simulator',
    subtitle:
      'Explore drawdown capacity, loss streaks, and illustrative Monte Carlo outcomes from your own inputs',
    icon: '🛡',
    href: '/tools/trader-survival-simulator',
