      ...
      {trophies.length > 1 && (
        <div className="mb-4 flex flex-wrap items-end gap-3">
          <div className="min-w-0 flex-1 sm:flex-none">
            ...
            <div className="relative">
              <select className="w-full sm:w-auto appearance-none rounded-lg border border-white/10 bg-[#0b0b14] px-3 py-2 pr-8 text-sm text-white/70 outline-none focus:border-cyan-400/60 cursor-pointer" value={firmFilter} onChange={(e) => setFirmFilter(e.target.value)}>
          ...
          <div className="min-w-0 flex-1 sm:flex-none">
            ...
            <div className="relative">
              <select className="w-full sm:w-auto appearance-none rounded-lg border border-white/10 bg-[#0b0b14] px-3 py-2 pr-8 text-sm text-white/70 outline-none focus:border-cyan-400/60 cursor-pointer" value={categoryFilter} onChange={(e) => setCategoryFilter(e.target.value)}>
