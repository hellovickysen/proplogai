...
import { createSetup, updateSetup, deleteSetup, seedDefaultSetups, resetToDefaultSetups } from '@/app/dashboard/playbook/actions';
...
export default function PlaybookPage({ setups, customSetupLimit = -1, planAccess = null }) {
  ...
  if (setups.length === 0) {
    return (
      <div className="px-4 sm:px-6 py-8">
        ...
        <p className="mt-1 text-sm text-white/55">Define your trading setups and execution criteria. Each setup belongs in your playbook.</p>
        ...
        <div className="mt-8 rounded-2xl border border-white/10 bg-white/[0.03] p-10 text-center">
          ...
          <p className="mx-auto mt-2 max-w-md text-sm text-white/55">
            Your playbook defines the setups you trade and the execution criteria for each one.
